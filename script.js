// --- script.js - DEFINITIVE VERSION ---

let people = {};
const TAX_RATE = 0.05; // 5%

// Functions defined globally so they are easy to access if needed,
// but we will primarily use Event Listeners.
...
function updateUI() {
    ...
    personNames.forEach(name => {
        ...
        // NOTE: The buttons in the UI for items/fees still use 'onclick' 
        // because those elements are dynamically created in the script.
        const itemInput = `
            <div class="input-row">
...
// This attaches the functionality ONLY after the page structure is ready
document.addEventListener('DOMContentLoaded', function() {
    // 1. Get the button using its ID
    const addPersonButton = document.getElementById('addPersonButton');
    
    // 2. Attach the function to the button click event
    if (addPersonButton) {
        addPersonButton.addEventListener('click', addPersonFromInput);
    }
